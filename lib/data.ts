...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tags: [
      { label: 'NGO', color: '#3ECF8E' },
      { label: 'React', color: '#61DAFB' },
      { label: 'Animation', color: '#FF9900' },
    ],
...
export const TECH_STACK: Tech[] = [
  // Core
  { name: 'Python', icon: 'python', category: 'core', proficiency: 85, projects: 8, color: '#3776AB', description: 'Primary language — scripting, data, web, automation' },
  { name: 'TypeScript', icon: 'typescript', category: 'core', proficiency: 80, projects: 6, color: '#3178C6', description: 'Typed JS for all modern projects' },
  { name: 'JavaScript', icon: 'javascript', category: 'core', proficiency: 80, projects: 10, color: '#F7DF1E', description: 'Foundation of all web work' },
  // Data & ML
  { name: 'NumPy', icon: 'numpy', category: 'data', proficiency: 75, projects: 4, color: '#4DABCF', description: 'Numerical computing in Python' },
  { name: 'Pandas', icon: 'pandas', category: 'data', proficiency: 75, projects: 4, color: '#150458', description: 'Data manipulation & analysis' },
  { name: 'Matplotlib', icon: 'matplotlib', category: 'data', proficiency: 70, projects: 3, color: '#11557C', description: 'Data visualization & plotting' },
  { name: 'Scikit-learn', icon: 'scikitlearn', category: 'data', proficiency: 60, projects: 2, color: '#F7931E', description: 'Machine learning basics' },
  { name: 'Jupyter', icon: 'jupyter', category: 'data', proficiency: 75, projects: 5, color: '#F37626', description: 'Interactive data exploration' },
  // Cloud (Learning)
  { name: 'AWS', icon: 'amazonaws', category: 'cloud', proficiency: 35, projects: 0, color: '#FF9900', description: 'Currently learning — EC2, S3, Lambda' },
  { name: 'Azure', icon: 'microsoftazure', category: 'cloud', proficiency: 30, projects: 0, color: '#0078D4', description: 'Currently learning — ADF, ADB' },
  { name: 'Databricks', icon: 'databricks', category: 'cloud', proficiency: 20, projects: 0, color: '#FF3621', description: 'Learning — Spark + ML platform' },
  { name: 'GCP', icon: 'googlecloud', category: 'cloud', proficiency: 20, projects: 0, color: '#4285F4', description: 'Exploring Google Cloud' },
  // Web
  { name: 'React', icon: 'react', category: 'web', proficiency: 85, projects: 8, color: '#61DAFB', description: 'Component-based UI development' },
  { name: 'Next.js', icon: 'nextdotjs', category: 'web', proficiency: 80, projects: 5, color: '#ffffff', description: 'Full-stack React framework' },
  { name: 'Tailwind CSS', icon: 'tailwindcss', category: 'web', proficiency: 90, projects: 10, color: '#06B6D4', description: 'Utility-first CSS framework' },
  { name: 'Framer Motion', icon: 'framer', category: 'web', proficiency: 75, projects: 4, color: '#0055FF', description: 'Production animations & transitions' },
  { name: 'Supabase', icon: 'supabase', category: 'web', proficiency: 75, projects: 3, color: '#3ECF8E', description: 'Backend-as-a-service, PostgreSQL' },
  { name: 'Node.js', icon: 'nodedotjs', category: 'web', proficiency: 65, projects: 4, color: '#339933', description: 'Server-side JavaScript' },
  { name: 'Flask', icon: 'flask', category: 'web', proficiency: 70, projects: 3, color: '#ffffff', description: 'Lightweight Python web framework' },
  // DevOps
  { name: 'Git', icon: 'git', category: 'devops', proficiency: 80, projects: 20, color: '#F05032', description: 'Version control for all projects' },
  { name: 'Docker', icon: 'docker', category: 'devops', proficiency: 45, projects: 1, color: '#2496ED', description: 'Containerization basics' },
  { name: 'Vercel', icon: 'vercel', category: 'devops', proficiency: 85, projects: 10, color: '#ffffff', description: 'Primary deployment platform' },
  { name: 'PostgreSQL', icon: 'postgresql', category: 'devops', proficiency: 65, projects: 3, color: '#336791', description: 'Relational database' },
]
